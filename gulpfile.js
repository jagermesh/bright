...
const configs = {
  ...
  concat: {
    ...
    dist: [
      { src: [ '3rdparty/bootstrap/latest/js/bootstrap.min.js', 'dist/js/bright.core.js' ],
        name: 'bright.nojq.js',
        dest: 'dist/js/'
      },
      { src: [ '3rdparty/jquery/latest/js/jquery.min.js', 'dist/js/bright.core.js' ],
        name: 'bright.nobs.js',
        dest: 'dist/js/'
      },
      { src: [ '3rdparty/jquery/latest/js/jquery.min.js', '3rdparty/bootstrap/2.3.2/js/bootstrap.min.js', 'dist/js/bright.core.js' ],
        name: 'bright.bs2.js',
        dest: 'dist/js/'
      },
      { src: [ '3rdparty/jquery/latest/js/jquery.min.js', '3rdparty/bootstrap/3.4.1/js/bootstrap.min.js', 'dist/js/bright.core.js' ],
        name: 'bright.bs3.js',
        dest: 'dist/js/'
      },
