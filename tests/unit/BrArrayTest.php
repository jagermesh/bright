...
class BrArrayTest extends \Codeception\Test\Unit
{
  ...
  public function testArray()
  {
    ...
    $this->assertEquals(true, br($testArray1)->exists(['apple', 'cow']));
    $this->assertEquals(true, br($testArray1)->exists(['cow', 'apple']));
    $this->assertEquals(true, br($testArray1)->exists(['apple', 'raspberry']));
    $this->assertEquals(false, br($testArray1)->exists(['apples', 'raspberies']));
    ...
    $this->assertEquals(false, br($testArray3)->exists(['']));
    $this->assertEquals(false, br($testArray3)->exists([]));
    $this->assertEquals(false, br($testArray3)->exists([null]));

    $this->assertEquals(true, br('apple')->exists('apple'));
    $this->assertEquals(true, br('apple')->exists(['apple']));
    $this->assertEquals(true, br('apple')->exists(['apples', 'apple']));
    $this->assertEquals(true, br('apple')->exists(['apple', 'apples']));
    ...
    $this->assertEquals(true, br([
      'name1' => 1,
      'name2' => 2,
    ])->hasOnlyNames(['name1', 'name2']));
    $this->assertEquals(false, br([
      'name1' => 1,
      'name2' => 2,
    ])->hasOnlyNames(['name1']));
    $this->assertEquals(false, br([
    ...
    $this->assertEquals(true, br([
      'name1' => 1,
      'name2' => 2,
    ])->hasOnlyNames(['name1', 'name2', 'name3']));

    $this->assertEquals([1, 2], br([[
      'id' => 1,
    ], [
      'id' => 2,
    ]])->valuesOf('id'));
