...
class BrOAuth_V1 extends BrRemoteConnection {
  ...
  private function prepareSignedRequest($method, $url, $params = array(), $content = '', array $additionalHeaders = array()) {
    ...
    if (br($checkurl, 'scheme') && br($checkurl,'host') && br($checkurl,'path')) {
      ...
      $requestParams = [ 'connect_timeout' => 10
                       , 'read_timeout'    => 50
                       , 'timeout'         => 60
                       , 'body'            => $content
  ...
  public function sendSignedRequestAsync($method, $url, $params = array(), $content = '', array $additionalHeaders = array()) {
